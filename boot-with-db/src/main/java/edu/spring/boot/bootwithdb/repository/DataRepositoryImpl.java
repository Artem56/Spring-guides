...
import edu.spring.boot.bootwithdb.entity.Data;
...
public class DataRepositoryImpl implements DataRepository<Data> {
    ...
    public void persist(Data object) {
        ...
        jdbcOperations.update("INSERT INTO data(\n" +
    ...
    public void delete(Data object) {
        jdbcOperations.update("DELETE FROM data\n" +
    ...
    public Set<String> getRandomData() {
        ...
        SqlRowSet rowSet = jdbcOperations.queryForRowSet("SELECT data_description FROM data p ORDER BY RANDOM() LIMIT 50;");
        while (rowSet.next()) {
